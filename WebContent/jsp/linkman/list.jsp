...
<BODY>
	<%-- <FORM id="customerForm" name="customerForm"
		...
		method=post> --%>
		<s:form action="linkMan_listPage.action" namespace="/" method="post"
				id="customerForm" name="customerForm">
											...
											<TBODY>
												<TR>
													...
													<!-- <INPUT class=textbox id=sChannel2
														...
														<s:textfield name="lkm_name" cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 80px"
																		maxLength="50">
														</s:textfield>
														</TD>
														<TD>性别：</TD>
														<TD>
														<s:select list="#{'1':'男','0':'女'}" headerKey="" headerValue="---请选择---" name="lkm_gender"></s:select>
														</TD>
										...
										<TABLE id=grid
											...
											<%-- 	<c:forEach items="${list }" var="linkman">--%>
												...
												<TR
													...
													<TD>
														<s:a action="linkMan_editShow.action" namespace="/">
															<s:param name="lkm_id" value="lkm_id"/>
																修改
														</s:a>
													&nbsp;&nbsp;
														<s:a action="linkMan_delete.action" namespace="/" cssClass="delLink">
															<s:param name="lkm_id" value="lkm_id"/>
															删除
														</s:a>
													</TD>
