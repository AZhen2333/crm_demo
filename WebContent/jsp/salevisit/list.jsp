										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												...
												<%-- 	<INPUT class=textbox id="visit_time"
														...
														<s:textfield name="visit_start_time" value="%{#pagination.parameterMap.visit_start_time[0]}" cssClass="textbox" id="visit_start_time"
														readonl="true" style="WIDTH: 80px" maxLength="20" />
													</TD>
													<TD>至</TD>
													<TD>
													<%-- <INPUT class=textbox id="visit_end_time"
														...
														<s:textfield name="visit_end_time" value="%{#pagination.parameterMap.visit_end_time[0]}" cssClass="textbox" id="visit_end_time"
														readonl="true" style="WIDTH: 80px" maxLength="20" />
													</TD>
