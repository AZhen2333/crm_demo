									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<s:a action="linkMan_showAdd.action" namespace="/" cssClass="style2" target="main">
															－ 新增联系人
														</s:a>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<s:a action="linkMan_listPage.action" cssClass="style2" namespace="/" target="main">
															－联系人列表
														</s:a></TD>
												</TR>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<s:a action="saleVisit_add" namespace="/" cssClass="style2" target="main">
															－新增客户拜访
														</s:a>	
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<s:a action="saleVisit_listPage" namespace="/" cssClass="style2" target="main">
															－客户拜访列表
														</s:a>	
													</TD>
												</TR>
